...
<body>
    <form id="form1" runat="server">
        ...
        <asp:gridview Font-Size="13px" ID="Gridview1" runat="server" Height="195px" Width="315px" CellPadding="4" ForeColor="#333333" AllowPaging="True" DataSourceID="contacts" AutoGenerateEditButton="True" DataKeyNames="ContactId" AutoGenerateDeleteButton="True" AllowSorting="True">
