...
?>
        <h1>Development</h1>
        <p>
        Sooda is an open source software, so the source code is available to public and everyone 
        can join the project to improve it. Contact <a href="mailto:jaak@zd.com.pl">Jarek</a> to get Subversion access.
        </p>
        ...
        <ul>
            ...
            <li><a href="http://lists.sourceforge.net/lists/listinfo/sooda-pl-list">sooda-pl-list@lists.sourceforge.net</a> (Polish language mailing list).</li>
        </ul>
<?php write_end_page(); ?>
